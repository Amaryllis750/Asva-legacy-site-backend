...
class ContentAdmin(UnfoldAdmin.ModelAdmin):
...
@admin.register(Team)
class TeamAdmin(UnfoldAdmin.ModelAdmin):
    list_display = ["name", "created_at"]
    search_fields = ["name"]


@admin.register(TeamJoinRequest)
class TeamJoinRequestAdmin(UnfoldAdmin.ModelAdmin):
...
class UserTeamAdmin(UnfoldAdmin.ModelAdmin):
    list_display = ["user", "team", "joined_at"]
    list_filter = ["team"]


@admin.register(Event)
class EventAdmin(UnfoldAdmin.ModelAdmin):
...
@admin.register(Link)
class LinkAdmin(UnfoldAdmin.ModelAdmin):
...
class InternshipAdmin(UnfoldAdmin.ModelAdmin):
...
class DocumentAdmin(UnfoldAdmin.ModelAdmin):
    list_display = ["title", "url", "team", "created_at"]
    list_filter = ["team"]
    search_fields = ["title"]
...
class CertificateAdmin(UnfoldAdmin.ModelAdmin):
